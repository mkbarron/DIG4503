...
const PostList = () => {
    ...
    return (
        <div style={{ padding: "30px 20px", textAlign: "center", backgroundColor: "#255957", color: "white"}} >
            <h1 style={{ paddingTop: "30px", paddingBottom: "10px", textAlign: "center", backgroundColor: "#255957", color: "#EEEBD3"}}>Michelle's Question of the February</h1>
            <p style={{ paddingTop: "30px", paddingBottom: "50px", marginLeft: "420px", marginRight: "420px", textAlign: "center", color: "#EEEBD3"}}>Last month I asked you this question and I was blown away by your answers! Now it's time to vote
             for your favorite response. Winner will be awarded with a $25 gift card to a restaurant of their choice via email. Contest ends March 6th, 2020 at 11:59PM EST. </p>
            ...
            posts.map((post) => {
                ...
                return (
                    <div style={{ paddingLeft: "50px", paddingRight: "50px", marginLeft: "420px", marginRight: "420px", textAlign: "center", backgroundColor: "#EEEBD3"}} key={id}>
                        <h5 style={{ paddingTop: "30px", textAlign: "center", color: "#255957"}}>User #{id} answered:</h5>
                        <h6 style={{ paddingBottom: "30px", textAlign: "center", color: "#255957"}}>{body}</h6>
                    </div>
                )
            })}
        </div>
